...
df_GG =  DataFrame(CSV.File(path_to_folder*"time_GG.csv"))
df_InstEval =  DataFrame(CSV.File(path_to_folder*"time_InstEval.csv"))[vcat(1:6, 9:14), :]
...
open(path_to_folder*"time_summary.tex", "w") do f
